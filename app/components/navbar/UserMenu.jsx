    ...
    return (
        <div className={'relative'}>
            <div className={'flex items-center gap-3'}>
                <div onClick={() => console.log('Airbnb your home')} className={'hidden md:block px-4 py-3 rounded-full hover:bg-neutral-100 transition cursor-pointer text-sm font-semibold'}>
                    Airbnb your home
                </div>
